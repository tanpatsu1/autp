...
| --- | --- | --- | --- | --- |
| autp-orchestrator | Select the next safe task and route work across autp roles. | Task prioritization, role decomposition, status coordination, and human-confirmation routing. | active | `docs/task-board.md`, `docs/role-map.md`, `docs/automation-policy.md`, `docs/feedback-inbox.md` |
...
No additional skills are proposed in this pass. Use `autp-skill-discovery` to add future proposals when a repeated workflow appears.
